		...
		<div class="container">
			<div class="col-md-12">
				<div class="col-md-8 col-md-offset-2">
					<h2 class="h2 text-center">Student <small>Register</small></h2>
					...
					<form method="post" id="register-form">
						...
						<div class="col-md-8 col-md-offset-2 form-group">
							<label>Adm No:</label>
							<input type="number" class="form-control login-field" name="reg_no" placeholder="Enter ADM NO" id="login-no" required />
							<span class="help-block " id="error"></span>
						</div>
						<div class="col-md-8 col-md-offset-2 form-group">
